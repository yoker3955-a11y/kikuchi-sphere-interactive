...
replace('<link rel="stylesheet" href="style.css?v=20260923-tilt1">', '<link rel="stylesheet" href="style.css?v=20260923-tilt1">\n  <link rel="stylesheet" href="style-lite.css">');
replace('<script src="viewer-drawings.js?v=20260923-tilt1" defer></script>', '<script src="texture-loader-lite.js" defer></script>\n  <script src="viewer-lite.js" defer></script>');
...
html = html.replace('texture-loader-lite.js"','texture-loader-lite.js?v=20260910-progress1"').replace('style-lite.css"','style-lite.css?v=20260910-progress1"').replace('viewer-lite.js"', 'viewer-lite.js?v=20260923-tilt1"');
